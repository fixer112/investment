...
Route::get('/cus/invest_card', 'CustomerController@getInvestCard');
Route::post('/cus/invest_card', 'CustomerController@postInvestCard');
...
Route::post('/stats/records', 'AdminController@details');
