                                    ...
                                    <table id="history" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{asset($history->proof)}}"><button class="btn btn-primary">View Proof</button></a>

                                                <a href="/admin/cus/{{$history->user->id}}"><button class="btn btn-primary">View Customer</button></a>
