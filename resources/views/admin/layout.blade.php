    ...
    <body class="fix-header fix-sidebar">
        ...
        <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                                    aria-haspopup="true"
                                    aria-expanded="false"><strong>{{ Auth::user()->name }}</strong></a>
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a href="/admin/referals" aria-expanded="false"><i class="fa fa-eye"></i><span
                                        class="hide-menu">Referals</span></a>
                            </li>
                            <li> <a href="/admin/identity" aria-expanded="false"><i class="fa fa-bell"></i>
                                    @if(count($identitys)>0)
                                    <span class="notify"><span class="heartbit"></span> <span
                            ...
                            <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-search"></i><span
                            ...
                            <li> <a href="/stats" aria-expanded="false"><i class="fa fa-pie-chart"></i><span
                                        class="hide-menu">All Statistics</span></a>


                            <li class="nav-label">Application</li>
                            <li> <a href="/notify" aria-expanded="false"><i class="fa fa-bell"></i><span
                                        class="hide-menu">Send Notification</span></a>
                            </li>
            ...
            <div class="page-wrapper">
                        ...
                        <div class="modal-dialog modal-confirm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="#" id="link"><button type="button"
                ...
                <!-- End Container fluid  -->
                <!-- footer -->
                <footer class="footer"> © {{date('Y')}} All rights reserved. <a href="https://altechtic.com">Altechtic
                        Solutions</a></footer>
                <!-- End footer -->
            </div>
            <!-- End Page wrapper  -->
