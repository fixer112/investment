    ...
    <div class="card-body">
            ...
            <div class="alert alert-danger alert-dismissible fade show col-lg-12 p-20">
                ...
                <div class="col-md-6 mx-auto">
                        <form method="POST" action="/cus/edit" files="true" enctype="multipart/form-data">
                        @csrf
                                ...
                                @endif
                                    ...
                                    <div class="form-group {{$errors->has('number') ? 'invalid-feedback' : ''}}">
                                        ...
                                        <input type="text" name="number" class="form-control" placeholder="{{Auth::user()->number}}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group {{$errors->has('acc_no') ? 'invalid-feedback' : ''}}">
                                        ...
                                        <input type="text" name="acc_no" class="form-control" value="{{Auth::user()->acc_no}}" required>
                                ...
                                @endif
                                    ...
                                    <div class="form-group {{$errors->has('acc_name') ? 'invalid-feedback' : ''}}">
                                        ...
                                        <input type="text" name="acc_name" class="form-control" value="{{Auth::user()->acc_name}}" required>
                                ...
                                @endif
                                    ...
                                    <div class="form-group {{$errors->has('addr') ? 'invalid-feedback' : ''}}">
                                        <label>Address</label>
                                        <input type="text" name="addr" class="form-control" value="{{Auth::user()->addr}}" required>
                                        @if ($errors->has('addr'))
                                    <span class="invalid-feedback">
                                ...
                                @endif
                                    ...
                                    <div class="form-group {{$errors->has('mode_id') ? 'invalid-feedback' : ''}}">
                                        ...
                                        {{-- <input type="text" name="mode_id" class="form-control" value="{{Auth::user()->mode_id}}" placeholder="e.g National Idcard" required> --}}
